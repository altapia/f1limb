...
AS 
 ...
 round((IFNULL(c1.ganancia,0) +  IFNULL(c2.ganancia, 0) +  IFNULL(c3.ganancia, 0) +  IFNULL(c4.ganancia, 0) +  IFNULL(c5.ganancia, 0) +  IFNULL(c6.ganancia, 0) +  IFNULL(c7.ganancia, 0) +  IFNULL(c8.ganancia, 0) +  IFNULL(c9.ganancia, 0) +  IFNULL(c10.ganancia, 0) +  IFNULL(c11.ganancia, 0) +  IFNULL(c12.ganancia, 0) +  IFNULL(c13.ganancia, 0) +  IFNULL(c14.ganancia, 0) +  IFNULL(c15.ganancia, 0) +  IFNULL(c16.ganancia, 0) +  IFNULL(c17.ganancia, 0) +  IFNULL(c18.ganancia, 0) +  IFNULL(c19.ganancia, 0) +  IFNULL(c20.ganancia, 0) +  IFNULL(c21.ganancia, 0) +  IFNULL(c22.ganancia, 0) +  IFNULL(c23.ganancia, 0) +  IFNULL(c24.ganancia, 0)),2) as ganancia
 from user u 
